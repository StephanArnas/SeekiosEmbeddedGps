/* Auto-generated config file hpl_usb_d_v111a_config.h */
#ifndef HPL_USB_D_V111A_CONFIG_H
#define HPL_USB_D_V111A_CONFIG_H
...
#define CONF_USB_D_N_6 6
#define CONF_USB_D_N_7 7
#define CONF_USB_D_N_8 8
#define CONF_USB_D_N_9 9
#define CONF_USB_D_N_10 10
#define CONF_USB_D_N_11 11
#define CONF_USB_D_N_12 12
#define CONF_USB_D_N_13 13
#define CONF_USB_D_N_14 14
#define CONF_USB_D_N_15 15
...
#define CONF_USB_D_N_EP_MAX ( CONF_USB_D_EP_N_MAX * 2 - 1 )
	...
	// <CONF_USB_D_N_0"> 0 (only EP0)
	// <CONF_USB_D_N_1"> 1 (EP 0x81 or 0x01)
	// <CONF_USB_D_N_2"> 2 (EP 0x82 or 0x02)
	// <CONF_USB_D_N_3"> 3 (EP 0x83 or 0x03)
	// <CONF_USB_D_N_4"> 4 (EP 0x84 or 0x04)
	// <CONF_USB_D_N_5"> 5 (EP 0x85 or 0x05)
	// <CONF_USB_D_N_6"> 6 (EP 0x86 or 0x06)
	// <CONF_USB_D_N_7"> 7 (EP 0x87 or 0x07)
	// <CONF_USB_D_EP_N_MAX"> Max possible (by HW)
...
#    define CONF_USB_D_MAX_EP_N CONF_USB_D_N_2
	...
	// <i> Limits the number of endpoints (described by EP address) can be used in app. E.g., if the device is designed to have EP0x0, EP0x01, EP0x81, this number should be at least 3.
	// <i> Reduce the value according to specific device design, to cut-off memory usage.
	// <CONF_USB_D_N_1"> 1 (EP0 only)
	// <CONF_USB_D_N_2"> 2 (EP0 + 1 endpoint)
	// <CONF_USB_D_N_3"> 3 (EP0 + 2 endpoints)
	// <CONF_USB_D_N_4"> 4 (EP0 + 3 endpoints)
	// <CONF_USB_D_N_5"> 5 (EP0 + 4 endpoints)
	// <CONF_USB_D_N_6"> 6 (EP0 + 5 endpoints)
	// <CONF_USB_D_N_7"> 7 (EP0 + 6 endpoints)
	// <CONF_USB_D_N_8"> 8 (EP0 + 7 endpoints)
	// <CONF_USB_D_N_9"> 9 (EP0 + 8 endpoints)
	// <CONF_USB_D_N_10"> 10 (EP0 + 9 endpoints)
	// <CONF_USB_D_N_11"> 11 (EP0 + 10 endpoints)
	// <CONF_USB_D_N_12"> 12 (EP0 + 11 endpoints)
	// <CONF_USB_D_N_13"> 13 (EP0 + 12 endpoints)
	// <CONF_USB_D_N_14"> 14 (EP0 + 13 endpoints)
	// <CONF_USB_D_N_15"> 15 (EP0 + 14 endpoints)
	// <CONF_USB_D_N_EP_MAX"> Max possible (by "Max Endpoint Number" config)
	// <i> For USB peripheral it's 2 * max ep number - 1, since EP0 must be control endpoint.
	// <id> usbd_num_ep_sp
...
#endif         // HPL_USB_D_V111A_CONFIG_H
